    ...
    <section id="experience" className="py-16 sm:py-24 px-4 sm:px-6 relative">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mt-2 text-foreground">{t.experience.title}</h2>
          <div className="w-20 h-1 bg-gradient-to-r from-primary to-accent rounded-full mt-4" />
        </motion.div>

        <div className="relative">
          <div className="absolute start-[15px] sm:start-[19px] top-0 bottom-0 w-px bg-gradient-to-b from-primary via-accent to-transparent" />
            ...
            {portfolioData.experience.map((exp, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="relative ps-10 sm:ps-12"
                >
                  <div className="absolute start-0 top-5 sm:top-6">
                    <div className="relative">
                      <div className="absolute -inset-2 rounded-full bg-primary/20 blur-sm" />
                      <div className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-lg shadow-primary/20">
                        <Briefcase className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-foreground" />
                      </div>
                    </div>
                  </div>
